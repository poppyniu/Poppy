...
public class ProductPutAPITest {
    ...
    public void productPutAPITest() throws Exception {
        ...
        StringEntity productPutBody = new StringEntity("{\"name\":\"edit product name\",\"productCode\":\"ab102934\",\"digest\":\"edit example\",\"description\":\"example\",\"specification\":\"example\",\"extra\":{},\"images\":[\"test.jpg\"],\"price\":0,\"originalPrice\":0,\"totalQuantity\":0,\"categoryIds\":[\"aaaaaaaa-bbbb-cccc-dddd-eeeeeeee\"],\"status\":2,\"family\":[{}],\"skus\":[{\"attrs\":[{\"name\":\"color\",\"value\":\"Red\"}],\"price\":0,\"quantity\":0}]}");
        String putResult = JsonUtility.putJsonContent(prouctPutUrl, productPutBody);

...
public class GroupMessageSwitching extends CommonWebDriver{
    ...
    public void switchGroupMessage(String testNGBrowser) throws Exception {
        ...
        CommonWebDriver.wait(driver, 2);
        if (CommonWebDriver.getElement(driver, By.xpath(".//*[@id='grid']/div/span")).getAttribute("innerHTML").contains("11-20")) {

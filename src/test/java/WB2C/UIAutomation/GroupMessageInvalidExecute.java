...
public class GroupMessageInvalidExecute extends CommonWebDriver{
    ...
    @Parameters({"browser"})
    @Test
    public void invalidExecuteGroupMessage(String testNGBrowser) throws Exception {
        ...
        CommonWebDriver.clickElementWhenPresent(driver, By.xpath(".//*[@id='grid']/table/tbody/tr[1]/td[8]/a[2]/li"));
        CommonWebDriver.wait(driver, 2);
        if (CommonWebDriver.isElementDisplayed(driver, By.xpath(".//*[@id='alertify']/div/article/p"))) {
            System.out.println("Execute without any content see the correct warning dialog, test pass! ");

...
public class AutoResponseEdit extends CommonWebDriver{
    ...
    public void editAutoResponse(String testNGBrowser) throws Exception {
        ...
        //edit test data
        CommonWebDriver.clickElement(driver, By.xpath(".//*[@id='grid']/table/tbody/tr/td[8]/a[3]/li"));
        CommonWebDriver.clearTextbox(driver, By.xpath(".//*[@id='keywords']"));
        CommonWebDriver.sendKeysToElement(driver, By.xpath(".//*[@id='keywords']"), "edit hello");
        CommonWebDriver.clickElement(driver, By.xpath(".//*[@id='btnSave']"));
        CommonWebDriver.wait(driver, 2);
        if (CommonWebDriver.getElement(driver, By.xpath(".//*[@id='grid']/table/tbody/tr/td[4]")).getAttribute("innerHTML").contains("edit")) {
            System.out.println("Create auto response succeed, test pass! ");
        }
        //delete test data

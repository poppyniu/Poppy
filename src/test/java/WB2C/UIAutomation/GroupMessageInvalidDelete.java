...
public class GroupMessageInvalidDelete extends CommonWebDriver{
    ...
    public void invalidDeleteGroupMessage(String testNGBrowser) throws Exception {
        ...
        if (CommonWebDriver.isElementDisplayed(driver, By.xpath(".//*[@id='alertify']/div/article/p"))) {
            System.out.println("Delete group message see the correct confirming dialog, scenario pass! ");
        } else
            CommonAssert.fail("Delete group message does not see the correct confirming dialog, scenario fail! ");
        //click cancel button
        CommonWebDriver.clickElement(driver, By.xpath(".//*[@id='alertify-cancel']"));
        if (CommonWebDriver.getElement(driver, By.xpath(".//*[@id='grid']/table/tbody/tr/td[2]")).getAttribute("innerHTML").contains("group message")) {
            System.out.println("Cancel to delete succeed, test pass! ");
        } else
            CommonAssert.fail("Cancel to delete get error, test fail! ");
        //delete test data
        CommonWebDriver.clickElement(driver, By.xpath(".//*[@id='grid']/table/tbody/tr/td[8]/a[4]/li"));

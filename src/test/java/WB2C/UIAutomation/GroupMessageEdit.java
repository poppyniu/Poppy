...
public class GroupMessageEdit extends CommonWebDriver{
    ...
    @Parameters({"browser"})
    @Test
    public void editGroupMessage(String testNGBrowser) throws Exception {
        ...
        CommonWebDriver.wait(driver, 2);
        //search the new added group message
        ...
        if (CommonWebDriver.getElement(driver, By.xpath(".//*[@id='grid']/table/tbody/tr/td[2]")).getAttribute("innerHTML").contains("group message")) {
            System.out.println("Create group message succeed, test pass! ");
        } else
            CommonAssert.fail("Create group message get error, test fail! ");
        //edit the group message
        CommonWebDriver.clickElementWhenPresent(driver, By.xpath(".//*[@id='grid']/table/tbody/tr[1]/td[8]/a[3]/li"));
        CommonWebDriver.clearTextbox(driver, By.xpath(".//*[@id='name']"));
        CommonWebDriver.sendKeysToElement(driver, By.xpath(".//*[@id='name']"), "edit group message");
        //click tab2
...
//        CommonWebDriver.clickElement(driver, By.xpath(".//*[@id='city_option_selected']"));
        ...
        if (CommonWebDriver.getElement(driver, By.xpath(".//*[@id='grid']/table/tbody/tr[1]/td[2]")).getAttribute("innerHTML").contains("edit")) {
            System.out.println("Edit group message succeed, test pass! ");
        } else

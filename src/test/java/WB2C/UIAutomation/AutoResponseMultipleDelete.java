...
public class AutoResponseMultipleDelete extends CommonWebDriver{
    ...
    @Parameters({"browser"})
    @Test
    public void multipleDeleteAutoResponse(String testNGBrowser) throws Exception {
        ...
        CommonWebDriver.clickElement(driver, By.xpath(".//*[@id='btnRemove']/i"));
        CommonWebDriver.wait(driver, 2);
        if (CommonWebDriver.isElementDisplayed(driver, By.xpath(".//*[@id='alertify']/div/article/p"))) {
            System.out.println("Delete multiple items see the correct warning dialog, test pass!");
        } else
            CommonAssert.fail("Delete multiple items does not see the correct warning dialog, test fail!");
        ...
        if (tableCount == expectCount) {
            System.out.println("Delete multiple auto response items succeed, test pass! ");
        } else
            CommonAssert.fail("Delete multiple auto response items get error, test fail!");
